      ...
      <div className="container-xl py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="mt-6">
              <span className="badge-luxury inline-flex items-center gap-1.5">
                <Shield className="w-3 h-3" /> Premium Property Management
              </span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                <li key={to}>
                  <Link to={to} className="hover:text-gold-500 dark:hover:text-gold-400 transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              {['Tenant Placement', 'Property Management', 'Rental Agreements', 'Maintenance Support', 'Investor Reports', 'Consultation Sessions'].map(s => (
                <li key={s} className="hover:text-gold-500 dark:hover:text-gold-400 transition-colors cursor-default">
                  {s}
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex gap-2.5 items-center">
                ...
                <a href="mailto:info@irur.com" className="hover:text-gold-500 transition-colors">info@irur.com</a>
              </li>
              <li className="flex gap-2.5 items-center">
                <Phone className="w-4 h-4 text-gold-500 flex-shrink-0" />
                <a href="tel:+17174336793" className="hover:text-gold-500 transition-colors">(717) 433-6793</a>
              </li>
            </ul>
            <Link to="/book-session" className="btn-luxury mt-5 text-xs py-2.5 px-4 inline-flex">
